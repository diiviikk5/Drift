...
function TargetTypeButton(props: TargetTypeButtonProps) {
	...
	return (
		<button
			...
			class={cx(
				"flex flex-1 flex-col items-center justify-center gap-1.5 rounded-lg border border-gray-5 bg-gray-3 py-3 text-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-9 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-1",
		...
		>
			...
			/>
			<p class="text-[12px] leading-none">{local.name}</p>
		</button>
	);
}
