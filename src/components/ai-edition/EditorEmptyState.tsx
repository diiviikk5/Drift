...
// user who already has a .drift project without media attached).
//
...
export function EditorEmptyState({
	...
	const handleDrop = useCallback(
		async (e: React.DragEvent) => {
			...
			const projectFile = files.find((f) => f.name.endsWith(".drift"));
			if (!projectFile) {
	...
	return (
		...
		>
			...
			<div className={styles.previewEmptyInner}>
				<img src="./drift.png" alt="" aria-hidden="true" className={styles.previewEmptyLogo} />
