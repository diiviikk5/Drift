...
export default function CaptureDock({
    ...
    return (
        <div className="bg-[#0D0E16]/95 backdrop-blur-2xl rounded-2xl border border-white/[0.08] p-5 shadow-[0_20px_50px_rgba(0,0,0,0.6)] space-y-4">
            <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className={`group relative px-7 py-3.5 rounded-xl flex items-center justify-center gap-3 transition-all duration-200 ${
                        isRecording
                            ? 'bg-red-500 hover:bg-red-600 text-white shadow-[0_0_25px_rgba(239,68,68,0.4)]'
                ...
                >
                    {isRecording ? (
                        <>
                            ...
                            <span className="font-extrabold text-sm tracking-wide uppercase">STOP CAPTURE</span>
                        </>
                    ) : (
                        <>
