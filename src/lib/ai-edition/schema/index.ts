...
// Drift's AI-edition merge (Phase 0, see technical-documentation/architecture/document-model.md):
//
...
//      so Drift's existing regions + appearance settings survive the merge.
//
...
// Drift additions to the axcut document. Mirrors src/components/video-editor/types.ts
...
// Legacy Drift appearance / export settings that the v3 schema doesn't
