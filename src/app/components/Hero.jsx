            ...
            <div className="relative z-10 max-w-6xl mx-auto w-full">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        {/* Download Beta Button (Temporary for Distribution) */}
                        <motion.div
                            className="mt-8 pt-8 border-t-2 border-[var(--border-default)]"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 1.0 }}
                        >
                            <p className="font-mono text-sm text-[var(--text-secondary)] mb-4">WANT TO TRY THE BETA?</p>
                            <div className="flex flex-col sm:flex-row items-center lg:items-start gap-4">
                                <a
                                    href="https://github.com/diiviikk5/Drift/releases/tag/v0.1.0-beta"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 font-mono font-bold text-[var(--text-primary)] hover:text-[var(--brutal-pink)] transition-colors group"
                                >
                                    <div className="w-12 h-12 bg-[var(--bg-secondary)] border-[3px] border-[var(--border-default)] flex items-center justify-center group-hover:translate-x-1 group-hover:translate-y-1 transition-transform">
                                    ...
                                    <span className="uppercase text-lg">View Release</span>
                                </a>
                                <span className="text-[var(--text-muted)] font-mono hidden sm:block">or</span>
                                <a
                                    href="https://github.com/diiviikk5/Drift/releases/download/v0.1.0-beta/Drift-win-x64.zip"
                                    download
                                    className="inline-flex items-center gap-2 font-mono font-bold text-[var(--text-primary)] hover:text-[var(--brutal-pink)] transition-colors group"
                                >
                                    <div className="w-12 h-12 bg-[var(--brutal-yellow)] border-[3px] border-[var(--border-default)] flex items-center justify-center group-hover:translate-x-1 group-hover:translate-y-1 transition-transform">
                                    ...
                                    <div className="flex flex-col items-start">
                                        <span className="uppercase text-lg">Direct Download</span>
                                        <span className="text-xs text-[var(--text-muted)]">Windows • 465 MB</span>
                                    </div>
                                </a>
                            </div>
                        </motion.div>
