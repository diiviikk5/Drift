...
export default function Hero() {
    ...
    useEffect(() => {
        ...
        async function fetchStars() {
            try {
                const res = await fetch("https://api.github.com/repos/diiviikk5/Drift");
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                >
                                    ...
                                    <div className="relative bg-[var(--bg-secondary)] border-[3px] border-[var(--border-default)] px-5 py-3 flex items-center justify-center gap-3">
                                        <svg className="w-5 h-5 text-[var(--text-primary)] group-hover:translate-y-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                                        </svg>
                                        <div className="text-left">
                                            <div className="font-mono font-bold text-sm text-[var(--text-primary)] uppercase">Download for Windows</div>
                                            <div className="font-mono text-xs text-[var(--text-muted)]">v2.0 • 21 MB • Installer</div>
                                        </div>
                                    </div>
                                </a>
                                <a
                                    ...
                                    className="flex items-center justify-center gap-2 px-4 py-3 border-[3px] border-[var(--border-default)] bg-[var(--bg-secondary)] font-mono text-sm font-bold text-[var(--text-secondary)] uppercase hover:text-[var(--text-primary)] hover:shadow-[4px_4px_0px_var(--border-default)] transition-all"
                                >
                                    ...
                                    <span>GitHub</span>
                                    {starCount !== null && (
                                        <span className="flex items-center gap-1 ml-1 px-2 py-0.5 bg-[var(--bg-tertiary)] border-[2px] border-[var(--border-default)] text-xs">
                                            <svg className="w-3.5 h-3.5 text-[var(--brutal-yellow)]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 .587l3.668 7.568 8.332 1.151-6.064 5.828 1.48 8.279-7.416-3.967-7.417 3.967 1.481-8.279-6.064-5.828 8.332-1.151z"/></svg>
                                            {starCount}
                                        </span>
                                    )}
                                </a>
