// Hidden-window runner for `drift record`. Reuses the full recording
...
/** A minimal .drift project referencing the finished recording, with all
 * editor settings at their defaults — ready for `drift export` or the GUI. */
